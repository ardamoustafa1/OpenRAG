...
litellm.api_key = "sk-placeholder"  # Proxy might not need auth internally if we secure the network
...
class LLMClient:
    ...
    async def aembed_batch(self, model: str, input_texts: list[str], tenant_id: str) -> list[list[float]]:
