...
class RerankerService:
    ...
    def __init__(self, model_name: str = "cross-encoder/ms-marco-MiniLM-L-6-v2", min_score: float = 0.3):
    ...
    def rerank(self, query: str, retrieved_chunks: List[Dict[str, Any]], top_k: int = 10) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            pairs = [[query, chunk["payload"].get("text", "")] for chunk in retrieved_chunks]
