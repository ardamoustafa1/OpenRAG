...
async def register_webhook(
    ...
    asyncio.create_task(
        notification_service.send_webhook(
            url, "ping", {"message": "Webhook configured successfully"}, secret
        )
    )
...
async def get_detailed_usage(
    ...
    return {
        ...
        "documents": {
            "used": doc_status.used,
            "limit": doc_status.limit,
            "percentage": doc_status.percentage,
        },
        "users": {
            "used": user_status.used,
            "limit": user_status.limit,
            "percentage": user_status.percentage,
        },
    }
