...
async def enforce_retention_policies():
    ...
    two_years_ago = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=365*2)
    five_years_ago = datetime.datetime.now(datetime.timezone.utc) - datetime.timedelta(days=365*5)
