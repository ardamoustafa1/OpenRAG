...
from app.core.observability import ai_observer
...
async def delete_my_data(user: dict = Depends(get_current_user)):
    ...
    async with async_session_factory() as db:
        ...
        try:
            ...
            logger.info("User requested data deletion. Execution successful.", pseudo_id=pseudo_id)
            
            return {"status": "success", "message": "All personal data has been permanently deleted or pseudonymized."}
