...
async def run_evaluation():
    ...
    if os.path.exists(dataset_path):
        ...
        data = {
            ...
            "contexts": [
                ["Our basic plan is $49, and enterprise pricing starts at $999/month."]
            ],
    ...
    if not os.environ.get("OPENAI_API_KEY"):
        print(
            "Warning: OPENAI_API_KEY not set. Ragas uses LLM-as-a-judge for evaluation. This may fail if no LiteLLM fallback is configured."
        )
