...
def test_sanitize_output():
    raw_output = (
        "The internal api key is sk-123456789012345678901234567890123456789012345678."
    )
...
def test_rrf_scoring_logic():
    ...
    dense_results = [
        {"id": "doc1", "payload": {"text": "A"}},
        {"id": "doc2", "payload": {"text": "B"}},
    ]
    sparse_results = [
        {"id": "doc2", "payload": {"text": "B"}},
        {"id": "doc3", "payload": {"text": "C"}},
    ]
...
def test_context_builder_deduplication_and_limit():
    ...
    chunks = [
        {
            "id": "1",
            "payload": {"text": "This is unique text.", "document_name": "Doc1"},
        },
        {
            "id": "2",
            "payload": {"text": "This is unique text.", "document_name": "Doc1"},
        ...
        {
            "id": "3",
            "payload": {"text": "This is another text.", "document_name": "Doc2"},
        },
    ]

    final_chunks, context_str = context_builder.build_context(
        chunks, max_context_tokens=1000
    )
